...
public class LL1APP {
    ...
    public static void main(String[] args) {
        ContextFreeGrammar cfg = LL1CFG.PLUS_MULTIPLY_EP_CFG;
        ...
        Map<String, Set<String>> firstSqSet = FirstSqSetUtil.getFirstSqSetUtil(cfg, nullableSet, firstSet, followSet);
